      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        ...
        <div>
          <button
            ...
            class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md mb-2 text-white bg-[#bb976d] hover:bg-[#bb976d] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#bb976d]"
